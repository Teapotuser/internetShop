                        ...
                        <div class="list-box">
                            ...
                            <div class="list-link open">
                                ...
                                <form class="left-form-filter" method="get"  action="">
                                    @foreach ($categories_all_forFilter as $categories_forFilter)
                                        @foreach ($categories_forFilter as $category_Filter)
                                            <li>
                                                <input class="" type="checkbox" id="{{ $category_Filter->id }}" name="category">
                                                <label class="" for="{{ $category_Filter->id }}">{{ $category_Filter->name }}</label>
                                            </li>  
                                        @endforeach
                                    @endforeach
                                    <!-- <li>
