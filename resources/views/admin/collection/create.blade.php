...
<div class="overview">
    <div class="title title-with-button">
        ...
        <div class="title-left">
            ...
            <span class="text">Добавление новой коллекции</span>  
        </div> 
...
<div class="form-wrapper"> 
    ...
    <form method="POST" action="{{ route('dashboard.collection.store') }}" enctype="multipart/form-data" class="login-form-decor">
        ...
        <div class="form-inner">
            ...
            <br>
            <textarea name="title_description" id="title_description" cols="40" rows="2" maxLength="1000" autocomplete="off">{{ old('title_description') }}</textarea>
