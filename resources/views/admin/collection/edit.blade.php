...
<div class="title title-with-button">
        ...
        <div class="title-left">
            ...
            <span class="text">Редактирование коллекции</span>  
        </div> 
...
<div class="form-wrapper"> 
    <!--Форма логина--> 
    <form method="POST" action="{{ route('dashboard.collection.update', $collection) }}" enctype="multipart/form-data" class="login-form-decor">
        @csrf
        @method('put')
