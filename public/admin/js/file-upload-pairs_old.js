...
document.querySelectorAll('.file-upload-container').forEach(function (fileUploadWrapper) {
...
<div class="file-upload-container">
    ...
    <input type="file" id="upload-button-41" class="upload-button" accept="image/*" name="preview_path[]">
    <label for="upload-button-41" class="upload-file-label upload-file-label-in-pair">
...
<div class="file-upload-container">
    ...
    <input type="file" id="upload-button-42" class="upload-button" accept="image/*" name="path[]">
    <label for="upload-button-42" class="upload-file-label upload-file-label-in-pair">
        <div class="file-upload-icon"></div>
